...
export default function AdminProfilScreen({ route }) {
    ...
    <ScrollView style={styles.container} contentContainerStyle={{paddingTop: 120}}>
            ...
            <View style={styles.userInfoContainer}>
              ...
              {userData?.alamat && (
                <View style={styles.userInfoRow}>
                  ...
                  <Text style={styles.userInfoLabel}>Alamat:</Text>
                  <Text style={styles.userInfoValue}>{userData.alamat}</Text>
                </View>
              )}
              {userData?.notelp && (
                <View style={styles.userInfoRow}>
                  ...
                  <Text style={styles.userInfoValue}>{userData.notelp}</Text>
                </View>
              )}
              <View style={styles.userInfoRow}>
                <Ionicons name="shield-checkmark" size={16} color="#4CAF50" />
                <Text style={styles.userInfoLabel}>Role:</Text>
                <Text style={[styles.userInfoValue, styles.adminRole]}>Administrator</Text>
              </View>
            </View>
          </>
        )}
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('DataWarga')}
        >
          <Ionicons name="people-circle" size={50} color="#4CAF50" />
          <Text style={styles.menuText}>Data Warga</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.menuItem}
          onPress={() => navigation.navigate('TambahWarga')}
        >
          <Ionicons name="person-add" size={50} color="#4CAF50" />
          <Text style={styles.menuText}>Tambah Warga</Text>
        </TouchableOpacity>
